#計算に用いるデータセット概要
#sinryou_agesex　3列 age, sex, sinryou
#sinryou_pref　2列 sinryou, prefname
#population_agesex　3列 age, sex, population
#population_pref　4列 prefname, age, sex, population
